...
function filterNames(modlist, list) {
    var names = TEST_WITH.concat(); // fixme: this magic belongs elsewhere

    // either get just the modules names matching a regex
    function regex(name) {
    ...
    // or check the whitelist from --testname option
